...
const checks = [
  ...
  runNode('persistent_context_state', ['--test', 'tests/context-state.test.mjs']),
  runNode('persistent_context_contracts', ['--test', 'tests/context-contracts.test.mjs']),
  runNode('v04_functional_modules', ['--test', 'tests/v04-modules.test.mjs']),
  runNode('v05_experience', ['--test', 'tests/v05-experience.test.mjs']),
  runNode('v06_workflow', ['--test', 'tests/v06-workflow.test.mjs']),
  runNode('v07_continuity', ['--test', 'tests/v07-continuity.test.mjs']),
  runNode('v08_mediated_context', ['--test', 'tests/v08-mediated-context.test.mjs']),
  runNode('v09_mcp_concurrency', ['--test', 'tests/v09-mcp-concurrency.test.mjs']),
  runNode('v10_foundation', ['--test', 'tests/v10-foundation.test.mjs']),
  runNode('v10_release', ['--test', 'tests/v10-release.test.mjs']),
  ...
  await readmeCheck('readme_en', 'README.md', [
    ...
    'npm run bridge -- recovery-export',
    'npm run bridge -- dry-run',
    'npm run bridge -- provide-context',
    'npm run mcp',
    'bridge_pull_context',
    'Version 1.0',
