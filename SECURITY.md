...
Security fixes are provided for the latest public `main` commit until the first tagged release, then for the latest tagged release.

## Report a Vulnerability

Use GitHub private vulnerability reporting for `ChenYvhang/codex-bridge-chatgpt` when available. Do not open a public issue containing credentials, private repository content, browser session data, or an exploitable proof of concept.
